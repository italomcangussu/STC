...
DECLARE
    ...
    new_pass TEXT;
BEGIN
    SELECT * INTO r FROM public.profiles WHERE name ILIKE '%kleno%' LIMIT 1;
    
    IF NOT FOUND THEN
        RAISE NOTICE 'Kleno not found';
        RETURN;
    END IF;

    -- Clean up identities and user
    ...
    -- Re-insert Identity (Omit email as it is generated)
    ...
    RAISE NOTICE 'Processo manual de "Nuclear Rebirth" concluído para Kleno';
END $$;
